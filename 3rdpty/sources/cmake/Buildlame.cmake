...
set(ICE_LAME_SOURCE_READY_TEST "test -f '${ICE_LAME_SOURCE_STAMP}' && ! find '${ICE_LAME_SOURCE_DIR}' -type f -newer '${ICE_LAME_SOURCE_STAMP}' ! -path '*/.git/*' -print -quit | grep -q .")
...
ExternalProject_Add(lame_project
    ...
    BUILD_COMMAND sh -c "${ICE_LAME_SOURCE_READY_TEST} || make -j${ICE_LAME_PROCESSOR_COUNT}"
    INSTALL_COMMAND sh -c "${ICE_LAME_SOURCE_READY_TEST} || (make install && ${CMAKE_COMMAND} -E touch '${ICE_LAME_SOURCE_STAMP}')"
